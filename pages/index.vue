...
let projects = [
    ...
    },
    {
        title: "Split",
        description: {
            FR: "Ce projet est destiné à partager les dépenses entre un groupe de personnes, réalisé en collaboration avec Théo SEMENTA, développeur iOS, et Elie DURIEUX, designer UI/UX.",
            EN: "This project is intended to share expenses among a group of people, created in collaboration with Théo SEMENTA, iOS developer, and Elie DURIEUX, UI/UX designer."
        },
        img: "split.jpg",
...
//     return projects.filter((item, index) => index % 3 === 0);
// });
//
// const secondCol = computed(() => {
//     return projects.filter((item, index) => index % 3 === 1);
// });
//
// const thirdCol = computed(() => {
//     return projects.filter((item, index) => index % 3 === 2);
// });
